...
class Config:
    def __init__(self, args):
        if args.dataset_file == 'H2O' or args.dataset_file == 'AssemblyHands':
            ...
            # self.cam_param = [636.6593017578125, 636.251953125, 635.283881879317, 366.8740353496978]
            # self.object_model_path = os.path.join(args.coco_path, 'H2O/object')
