...
class MSDeformAttn(nn.Module):
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes, input_level_start_index, input_padding_mask=None):
        ...
        """
        N, Len_q, _ = query.shape # (lvl_pos + input_feature)
        N, Len_in, _ = input_flatten.shape # (input_feature)
        ...
        if reference_points.shape[-1] == 2:
            ...
            sampling_locations = reference_points[:, :, None, :, None, :] \
                                 + sampling_offsets / offset_normalizer[None, None, None, :, None, :]    #(batch, num_queries, num_heads, num_features, num_offsets, 2)
            ...
            # ref_y = reference_points[:, :, None, :, None, 1].unsqueeze(-1)
            ######################### center refine #################################
            ...
            # sampling_locations = torch.cat([ref_x, ref_y], dim=-1) \
            #                      + sampling_offsets / self.n_points # * wh * 0.5
